...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form action="{{ route('quizzes.update', $quiz->id) }}" method="POST" id="quiz-form">
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ route('quizzes.show', $quiz->id) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                İptal
            </a>
