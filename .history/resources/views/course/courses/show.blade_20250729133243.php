<x-layouts.app>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                        ...
                                        >
                                            ...
                                            <div class="flex items-center">
                                                @if($isEnrolled || $lesson->is_free)
                                                    <button
                                                        onclick="Livewire.emit('loadLesson', {{ $lesson->id }})"
                        ...
                        <div class="flex flex-col sm:flex-row gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-4 flex justify-between max-w-xs">
                                    <div class="text-center">
                                        <div class="text-lg font-semibold">{{ $course->instructor->courses_count ?? 0 }}</div>
                                        <small class="text-gray-500">Kurs</small>
                                    </div>
                                    <div class="text-center">
                                        <div class="text-lg font-semibold">{{ $course->instructor->students_count ?? 0 }}</div>
                                        <small class="text-gray-500">Öğrenci</small>
                                    </div>
                                    <div class="text-center">
                                        <div class="text-lg font-semibold">{{ number_format($course->instructor->average_rating ?? 0, 1) }}</div>
                                        <small class="text-gray-500">Puan</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-xl shadow-sm p-6 sticky top-6">
                        ...
                        @elseif($isEnrolled)
                            <div class="mb-4">
                                <div class="alert alert-success bg-green-100 text-green-800 p-3 rounded-md mb-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Listen for lesson loading events
            window.addEventListener('lessonLoaded', function(event) {
                console.log('Lesson loaded:', event.detail.lessonId);
            });
            ...
            window.addEventListener('progressUpdated', function() {
                console.log('Progress updated');
                // You can add code here to refresh progress indicators if needed
                location.reload(); // Optional: reload page to show updated progress
            });
