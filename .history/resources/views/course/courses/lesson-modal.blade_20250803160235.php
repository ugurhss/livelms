                    ...
                    @if(request()->has('lesson'))
                        ...
                        <div class="p-4 md:p-6">
                            ...
                            <div class="relative aspect-w-16 aspect-h-9 bg-black rounded-lg overflow-hidden">
                                ...
                                <!-- Özel Kontroller -->
                                <div class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black to-transparent pt-10 pb-4 px-4">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="text-white text-sm mx-2 flex-1 text-center" id="videoTime">0:00 / 0:00</div>
