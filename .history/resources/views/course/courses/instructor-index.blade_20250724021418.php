...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('courses.create') }}" class="btn btn-success">Yeni Kurs Oluştur</a>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <form action="{{ route('courses.instructor') }}" method="GET" class="d-inline">
                    ...
                    <tbody>
                        @forelse($courses as $course)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('courses.courses.edit', $course->id) }}" class="btn btn-sm btn-outline-primary me-2">
                                            Düzenle
                                        </a>
