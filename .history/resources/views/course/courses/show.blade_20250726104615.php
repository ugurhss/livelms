                            ...
                            <div class="divide-y divide-gray-200">
                                @foreach($course->lessons as $index => $lesson)
                                    <div class="overflow-hidden">
                                        <div
                                            @if($expandableLessons) wire:click="toggleLesson({{ $index }})" @endif
                                            class="flex items-center justify-between p-6 @if($expandableLessons) cursor-pointer hover:bg-gray-50 transition-colors @endif"
                                        >
                                            <div class="flex items-center">
                                                @if($expandableLessons)
                                                    <svg
                                        ...
                                        @if($expandableLessons && in_array($index, $expandedLessons))
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 sticky top-6">
                        ...
                        @elseif($isEnrolled)
                            <div class="mb-4">
                                ...
                                {{-- <a href="{{ route('courses.learn', $course->id) }}" class="w-full block text-center mb-2 px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200">
                                    Öğrenmeye Devam Et
                                </a>
                                <a href="{{ route('courses.quiz', $course->id) }}" class="w-full block text-center mb-2 px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200">
                                    Sınavı Görüntüle
                                </a> --}}
                        ...
                        <div class="mt-8 space-y-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <span class="text-gray-700">30 gün para iade garantisi ugur</span>
                            </div>
                        </div>
                    </div>
...
<script>
    document.addEventListener('livewire:load', function() {
        // Kurs kayıt işlemi sonrası flash mesajlarını yönet
