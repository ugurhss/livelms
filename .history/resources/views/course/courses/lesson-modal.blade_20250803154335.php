...
<div class="aspect-w-16 aspect-h-9 mb-6 rounded-lg overflow-hidden bg-black relative">
    @if($currentLesson->video_type === 'youtube')
        <iframe class="w-full h-64 md:h-96"
                src="https://www.youtube.com/embed/{{ $currentLesson->video_id }}?modestbranding=1&rel=0&controls=1&disablekb=1&fs=0&showinfo=0"
                frameborder="0"
        ...
        <div class="absolute inset-0 pointer-events-none" onclick="return false;"></div>
    @else
