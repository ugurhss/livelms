<x-layouts.app>
    ...
    <!-- Course content -->
    @if($course)
        <!-- Livewire Lesson Player - Modal'ı bu sayfada tanımlıyoruz -->
<!-- After your course content -->
@livewire('lesson-player', ['course' => $course], key('lesson-player-'.$course->id))
                                        ...
                                        >
                                            ...
                                            <div class="flex items-center">
                                                @if($isEnrolled || $lesson->is_free)
                                                    <button
                                                        wire:click="$dispatch('loadLesson', { lessonId: {{ $lesson->id }} })"
                                                ...
                                                <div class="mt-4">
                                                    @if($isEnrolled || $lesson->is_free)
                                                        <div class="text-sm text-gray-600 bg-white p-3 rounded-md border border-gray-200">
                                                            Bu dersi izlemek için yukarıdaki "İzle" butonuna tıklayın.
                                                        </div>
                                                    @else
                                                        <div class="text-sm text-gray-600 bg-white p-3 rounded-md border border-gray-200">
