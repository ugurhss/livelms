            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <div class="flex-1 bg-black flex items-center justify-center relative">
                    @if($currentLesson && $currentLesson->video_url)
                        <!-- Video Türüne Göre Dinamik Yükleme -->
                        @switch($currentLesson->video_type)
                            @case('youtube')
                                <iframe
                                    src="https://www.youtube.com/embed/{{ $currentLesson->video_id }}?autoplay=1&modestbranding=1&rel=0"
                                    class="w-full h-full"
                                    frameborder="0"
                            ...
                            @case('vimeo')
                                <iframe
                                    src="https://player.vimeo.com/video/{{ $currentLesson->video_id }}?autoplay=1"
                                    class="w-full h-full"
                                    frameborder="0"
                            ...
                            @case('html5')
                                <video controls autoplay class="w-full h-full object-contain">
                                    <source src="{{ $currentLesson->video_url }}" type="video/{{ $currentLesson->video_format ?? 'mp4' }}">
                            ...
                            @default
                                <div class="text-center p-8 text-white">
                                    ...
                                    <h3 class="text-xl font-medium mb-2">Video Formatı Desteklenmiyor</h3>
                                    <p class="text-gray-300">Lütfen geçerli bir video bağlantısı ekleyin</p>
                                </div>
                        @endswitch
                    @else
                        <div class="text-center p-8 text-white">
