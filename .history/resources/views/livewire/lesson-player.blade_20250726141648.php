                ...
                <div class="flex-1 bg-black flex items-center justify-center relative">
                    ...
                    @else
                        <div class="text-center p-8 text-white">
                            ...
                            <div class="fixed bottom-0 left-0 bg-white p-2 text-xs z-50">
    <p>Current Lesson ID: {{ $currentLesson->id ?? 'null' }}</p>
    <p>Video URL: {{ $currentLesson->video_url ?? 'null' }}</p>
    <p>Video Type: {{ $currentLesson->video_type ?? 'null' }}</p>
</div>
