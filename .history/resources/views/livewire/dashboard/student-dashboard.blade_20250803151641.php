        ...
        <div class="space-y-4">
            @foreach($courseProgress as $course)
                @php
                    ...
                    $enrollment = collect($enrollments)->firstWhere('user_id', auth()->id());
                    $progress = $enrollment['progress'] ?? 0;
                    $completed = $enrollment['completed_lessons'] ?? 0;
                    $total = $enrollment['total_lessons'] ?? 0;
                @endphp
                <div>
                    ...
                    <div class="text-xs text-gray-500 mt-1">
                        {{ $completed }}/{{ $total }} ders tamamlandı
                    </div>
                    ...
                    <div class="mb-4 mt-2">
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div class="bg-blue-600 h-2 rounded-full"
                                 ...
                                 x-data="{ progress: 0 }"
                                 x-init="setTimeout(() => progress = {{ $progress }}, 100)">
                            </div>
                        </div>
                    </div>
                </div>
