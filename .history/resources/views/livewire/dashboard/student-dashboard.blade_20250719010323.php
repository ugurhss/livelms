                        ...
                        <div class="p-6 hover:bg-gray-50 transition duration-150">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">{{ $course['instructor'] ?? 'Bilinmiyor' }}</p>
                                    <div class="mt-2">
                        ...
                        <div class="p-6 hover:bg-gray-50 transition duration-150">
                            <div class="flex items-start justify-between">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">{{ $assignment['course']['title'] ?? 'Bilinmeyen Kurs' }}</p>
                        ...
                        <div class="p-6 hover:bg-gray-50 transition duration-150">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">{{ $deadline['course'] ?? 'Bilinmeyen Kurs' }}</p>
                                    <div class="mt-2 flex items-center text-sm text-gray-500">
                                        <svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
