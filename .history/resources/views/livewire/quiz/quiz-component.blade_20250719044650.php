<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <a href="{{ route('courses.quizzes.create', $courseId) }}"
           class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all">
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        @if($quizzes->isEmpty())
            <div class="p-8 text-center">
                ...
                <p class="mt-1 text-gray-500">Yeni bir quiz oluşturarak başlayabilirsiniz.</p>
                @can('create-quiz')
                <div class="mt-6">
...
<x-jet-dialog-modal wire:model="confirmingDeletion">
    ...
    <x-slot name="content">
        <p>Bu quizi silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.</p>
    </x-slot>
    ...
    <x-slot name="footer">
        ...
        <x-jet-danger-button class="ml-2" wire:click="deleteQuiz" wire:loading.attr="disabled">
            Sil
        </x-jet-danger-button>
    </x-slot>
</x-jet-dialog-modal>
