                ...
                <div class="w-full lg:w-3/5 bg-gray-900 flex flex-col">
                    ...
                    <div class="flex-1 relative">
                        @if($videoType === 'youtube' && $videoId)
                            ...
                            <div id="customPlayer" class="w-full h-full">
                                <div class="aspect-w-16 aspect-h-9 h-full w-full">
                                    <!-- YouTube iframe with modestbranding and no controls -->
                                    <iframe id="youtubeIframe" class="w-full h-full"
                                            src="https://www.youtube.com/embed/{{ $videoId }}?rel=0&modestbranding=1&controls=0&disablekb=1&fs=0"
                                            frameborder="0"
