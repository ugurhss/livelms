<div class="lesson-player-container bg-white rounded-xl shadow-sm p-6 mb-6">
    @if($lesson)
        ...
        <div class="video-container mb-4 cursor-pointer" onclick="openLessonModal()">
            ...
            @else
                <div class="bg-gray-100 rounded-lg p-8 text-center cursor-pointer" onclick="openLessonModal()">
