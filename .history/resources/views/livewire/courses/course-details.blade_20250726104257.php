                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-8">
                        ...
                        <div class="mt-8 space-y-6">
                            <div>
                                <h3 class="text-xl font-semibold mb-3 text-gray-900">Öğrenecekleriniz</h3>
                        ...
                        <div class="p-8 border-b">
                            ...
                            @if($course->lessons && $course->lessons->count() > 0)
                                <div class="mt-2 flex items-center justify-between">
                                    <span class="text-gray-600">{{ $course->lessons->count() }} ders</span>
                                    <button
                                        ...
                                        >
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-sm text-gray-500 mt-1">{{ $lesson->duration ?: '15 dk' }}</p>
                                                </div>
                                            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-8">
                        ...
                        <div class="flex flex-col sm:flex-row gap-6">
                            <img
                                src="{{ $course->instructor->avatar ?? asset('images/default-avatar.png') }}"
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 sticky top-6">
                        ...
                        @if(!$isEnrolled && !$isInstructor)
                            @if(Auth::check())
                                ...
                                >
                                    <span wire:loading.remove>Kursa Kayıt Ol</span>
                                    <span wire:loading>
                        ...
                        @elseif($isEnrolled)
                            <a
                                ...
                                class="w-full flex justify-center items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200"
                            >
                                Öğrenmeye Devam Et
                            </a>
                        @else
                        ...
                        <div class="mt-8 space-y-4">
                            <div class="flex items-start">
                                ...
                                <span class="text-gray-700">Toplam süre: {{ $this->totalDuration }}</span>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <span class="text-gray-700">30 gün para iade garantisi ugurcan</span>
                            </div>
                        </div>
                    </div>
                </div>
