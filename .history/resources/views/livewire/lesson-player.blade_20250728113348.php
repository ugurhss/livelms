                        ...
                        <div class="space-y-2">
                            ...
                            <div class="p-3 rounded-lg hover:bg-gray-50 cursor-pointer">
                                <div class="flex items-center">
                                    ...
                                    <p class="text-gray-700">Giriş ve Temel Kavramlar</p>
                                </div>
                            </div>
                            <div class="p-3 rounded-lg hover:bg-gray-50 cursor-pointer">
                                <div class="flex items-center">
                                    ...
                                    <p class="text-gray-700">Örnek Uygulamalar</p>
                                </div>
                            </div>
                            <div class="p-3 rounded-lg bg-blue-50 border border-blue-200">
                                <div class="flex items-center">
                                    ...
                                    <p class="text-blue-800 font-medium">İleri Konular (Şu an izleniyor)</p>
                                </div>
                            </div>
                            <div class="p-3 rounded-lg hover:bg-gray-50 cursor-pointer opacity-70">
                                <div class="flex items-center">
                                    ...
                                    <p class="text-gray-500">Uygulama Projesi</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full lg:w-3/5 bg-gray-900 flex flex-col">
                    ...
                    <div class="flex-1 relative">
                        @if($videoType === 'youtube' && $videoId)
                            ...
                            <!-- Custom YouTube player with hidden branding -->
                          <div class="absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300" id="controlsOverlay">
                                <button class="bg-black bg-opacity-50 rounded-full p-4 text-white hover:bg-opacity-70" onclick="togglePlay()">
                                    <svg id="playIcon" xmlns="http://www.w3.org/2000/svg" class="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="display: none;">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <svg id="pauseIcon" xmlns="http://www.w3.org/2000/svg" class="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<script>
    ...
    function openLessonModal() {
        ...
        // YouTube API yüklenmemişse yükle
    ...
    // Sayfa yüklendiğinde API yüklemesini başlat
    document.addEventListener('DOMContentLoaded', function() {
        // Video seek event listener
        document.getElementById('videoSeek').addEventListener('input', seekVideo);

        // Eğer modal açıksa player'ı başlat
        if (document.getElementById('lessonModal') && !document.getElementById('lessonModal').classList.contains('hidden')) {
            loadYouTubeAPI();
        }
    });
</script>
