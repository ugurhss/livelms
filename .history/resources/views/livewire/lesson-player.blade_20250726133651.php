                    ...
                    @if($videoUrl)
                        <div class="absolute inset-0 w-full h-full">
                            @if(str_contains($videoUrl, 'youtube.com'))
                                <iframe
                                    src="https://www.youtube.com/embed/{{ $this->extractYouTubeId($videoUrl) }}?autoplay=1&modestbranding=1&rel=0"
                                    class="w-full h-full"
                                    frameborder="0"
                ...
                <div class="border-t border-gray-200 bg-white">
                    <div class="p-6">
                        ...
                        <div class="mt-6 flex items-center space-x-4 text-sm text-gray-500">
                            ...
                            <span>•</span>
                            <span>
                                Ders {{ $currentLesson ? $currentLesson->order : 0 }}/{{ $lessons->count() }}
                            </span>
                        </div>
                    </div>
                </div>
