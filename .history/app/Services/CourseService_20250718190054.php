...
public function createCourse(array $data)
{
    ...
    // Gerekirse aynı slug'ların çakışmaması için benzersiz hale getirilebilir
    $originalSlug = $lessonData['slug'];
    $i = 1;
    while (Lesson::where('slug', $lessonData['slug'])->exists()) {
        $lessonData['slug'] = $originalSlug . '-' . $i++;
    }
