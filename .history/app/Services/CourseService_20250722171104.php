 ...
 public function updateCourse(int $courseId, array $data): Course
    {
        ...
        if ($course->user_id !== auth()->id()) {
            throw new \Exception('Bu kursu düzenleme yetkiniz yok');
        }
        ...
        if (isset($data['thumbnail'])) {
            $data['thumbnail'] = $this->updateThumbnail($course, $data['thumbnail']);
        }
     ...
     protected function updateThumbnail(Course $course, $thumbnail): string
    {
        // Eski resmi sil
        if ($course->thumbnail) {
        ...
        // Yeni resmi kaydet
        return $thumbnail->store('public/course-thumbnails');
    }
