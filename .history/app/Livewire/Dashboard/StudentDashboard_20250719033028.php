...
public function mount(StudentDashboardService $dashboardService)
{
        ...
        $this->enrolledCourses = $dashboardService->getEnrolledCourses();
        $this->activeAssignments = $dashboardService->getActiveAssignments();
        $this->completedAssignments = $dashboardService->getCompletedAssignments();
        $this->courseProgress = $dashboardService->getCourseProgress();
