...
$        $this->enrolledCoursesCount = $this->dashboardService->getEnrolledCoursesCount(Auth::id());
        $this->pendingAssignments = $this->dashboardService->getPendingAssignments(Auth::id());
        $this->completedAssignments = $this->dashboardService->getCompletedAssignments(Auth::id());
