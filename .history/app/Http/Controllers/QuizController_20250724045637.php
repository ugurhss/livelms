...
class QuizController extends Controller
{
    ...
    public function __construct(QuizService $quizService)
    {
        ...
        $this->middleware('can:manage-quiz,quiz')->except([
            'index', 'show', 'startQuiz',
    ...
    {
        Gate::authorize('create-quiz', $courseId);
    ...
    {
        $quiz = $this->quizService->getQuizDetails($quizId);
        Gate::authorize('delete-quiz', $quiz);
    ...
    {
        $quiz = $this->quizService->getQuizDetails($quizId);
        Gate::authorize('manage-quiz-questions', $quiz);
    ...
    public function startQuiz($courseId, $quizId)
    {
        ...
        // Kullanıcının daha önce quiz'i tamamlayıp tamamlamadığını kontrol et
