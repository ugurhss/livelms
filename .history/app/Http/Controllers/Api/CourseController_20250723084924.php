...
class CourseController extends Controller
{
    ...
    public function store(StoreCourseRequest $request)
    {
        try {
            ...
            return back()->withInput()
                ->with('error', 'Kurs oluşturulurken hata oluştu: ' . $e->getMessage());
        }
    }
    ...
    {
        $courses = $this->courseService->getCoursesByInstructor(Auth::id(), $request->all());
        return view('course.courses.instructor-index', compact('courses'));
    }
