...
$this->app->bind(
    ...
    public function boot(): void
    {
        ...
        Blade::component('jet-dialog-modal', 'jet-dialog-modal');
        Blade::component('jet-action-message', 'jet-action-message');
        Blade::component('jet-button', 'jet-button');
        Blade::component('jet-input', 'jet-input');
        Blade::component('jet-label', 'jet-label');
        Blade::component('jet-form-section', 'jet-form-section');
        Blade::component('jet-validation-errors', 'jet-validation-errors');
        Blade::component('jet-secondary-button', 'jet-secondary-button');
        Blade::component('jet-danger-button', 'jet-danger-button');
    }
}
