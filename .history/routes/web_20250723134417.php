...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Kurs İşlemleri (Elle yazılmış rotalar)
    Route::prefix('courses')->name('courses.')->group(function () {
        ...
        // Quiz işlemleri
        Route::prefix('{courseId}/quizzes')->name('quizzes.')->group(function () {
...
/*
|--------------------------------------------------------------------------
| ÇAKIŞMAYA SEBEP OLAN ESKİ SATIR — ARTIK KULLANMA
|--------------------------------------------------------------------------
| Bu satır elle yazdığın rotalarla çakışıyordu, yorum satırı yapıldı.
*/
