...
Route::middleware(['auth', 'verified'])->group(function () {
  ...
  Route::prefix('courses')->name('courses.')->group(function () {
    // Kurs Listesi
    Volt::route('/', 'courses.index')->name('index');
    ...
    // Kurs Düzenleme Formu (GET)
    Route::get('/{course}/edit', [CourseController::class, 'editWithLessons'])
        ->middleware('role.admin.instructor')
        ->name('edit');

    // Kurs Güncelleme (PUT)
    Route::put('/{course}/update', [CourseController::class, 'updateWithLessons'])
        ->middleware('role.admin.instructor')
        ->name('update');
