...
Route::middleware(['auth'])->group(function () {
    ...
    // Course quiz
    Route::get('/courses/{courseId}/quiz', [CourseController::class, 'quiz'])->name('courses.quiz');
});
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/courses/{courseId}/quizzes/{quizId}/edit', [QuizController::class, 'edit'])->name('quizzes.edit');
    Route::put('/courses/{courseId}/quizzes/{quizId}', [QuizController::class, 'update'])->name('quizzes.update');
    Route::delete('/courses/{courseId}/quizzes/{quizId}', [QuizController::class, 'destroy'])->name('quizzes.destroy');

    // Quiz Question Management
    Route::get('/courses/{courseId}/quizzes/{quizId}/questions/create', [QuizController::class, 'createQuestion'])->name('quizzes.questions.create');
    Route::post('/courses/{courseId}/quizzes/{quizId}/questions', [QuizController::class, 'storeQuestion'])->name('quizzes.questions.store');

    // Quiz Taking Routes
    Route::get('/courses/{courseId}/quizzes/{quizId}', [QuizController::class, 'show'])->name('courses.quizzes.show');
    Route::get('/courses/{courseId}/quizzes/{quizId}/start', [QuizController::class, 'startQuiz'])->name('quizzes.start');
    Route::post('/courses/{courseId}/quizzes/{quizId}/submit', [QuizController::class, 'submitQuiz'])->name('quizzes.submit');
    Route::get('/courses/{courseId}/quizzes/{quizId}/results/{attemptId}', [QuizController::class, 'showResult'])->name('quizzes.result');
});
...
Route::delete('/courses/{courseId}/quizzes/{quizId}', [QuizController::class, 'destroy'])
    ->name('courses.quizzes.destroy');

Route::get('/courses/{courseId}/quizzes/{quizId}/start', [QuizController::class, 'startQuiz'])
...
Route::get('/courses/{courseId}/quizzes/{quizId}/results/{attemptId}', [QuizController::class, 'showResult'])
