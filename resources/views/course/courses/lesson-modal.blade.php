                        ...
                        <div class="p-4 md:p-6">
                            ...
                            <div class="aspect-w-16 aspect-h-9 mb-6 rounded-lg overflow-hidden bg-black">
                                @if($currentLesson->video_type === 'youtube')
                                    <iframe class="w-full h-64 md:h-96" src="https://www.youtube.com/embed/{{ $currentLesson->video_id }}?modestbranding=1&rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                @else
